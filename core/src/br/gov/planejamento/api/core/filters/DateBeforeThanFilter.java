 ...
 * 
 * O retorno é formado por todos os resources cuja data é anterior (em dia, mês e ano) ao parâmetro recebido.
 *
 */
public class DateBeforeThanFilter extends Filter {

	private DateBeforeThanFilter(Class<? extends Object> type, DatabaseAlias...databaseAliases) {
		super(type, databaseAliases);
	}
	
	private DateBeforeThanFilter(Class<? extends Object> type, String...parameters) {
	...
	public static Filter factory(String... parameters) {
		return new DateBeforeThanFilter(DateParam.class, parameters);
	}
	...
	public static Filter factory(DatabaseAlias... databaseAliases){
		return new DateBeforeThanFilter(DateParam.class, databaseAliases);
	}
