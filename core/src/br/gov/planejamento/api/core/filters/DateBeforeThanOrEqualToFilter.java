 ...
 * 
 * O retorno é formado por todos os resources cuja data é exatamente igual ou anterior (em dia, mês e ano) ao parâmetro recebido.
 *
 */
public class DateBeforeThanOrEqualToFilter extends Filter {

	private DateBeforeThanOrEqualToFilter(Class<? extends Object> type, DatabaseAlias...databaseAliases) {
		super(type, databaseAliases);
	}
	
	private DateBeforeThanOrEqualToFilter(Class<? extends Object> type, String...parameters) {
	...
	public static Filter factory(String... parameters) {
		return new DateBeforeThanOrEqualToFilter(DateParam.class, parameters);
	}
	...
	public static Filter factory(DatabaseAlias... databaseAliases){
		return new DateBeforeThanOrEqualToFilter(DateParam.class, databaseAliases);
	}
