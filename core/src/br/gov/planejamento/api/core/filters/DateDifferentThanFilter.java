 ...
 * 
 * O retorno é formado por todos os resources cuja data é diferente (em dia, mês e ano) ao parâmetro recebido.
 *
 */
public class DateDifferentThanFilter extends Filter {

	private DateDifferentThanFilter(Class<? extends Object> type, DatabaseAlias...databaseAliases) {
		super(type, databaseAliases);
	}
	
	private DateDifferentThanFilter(Class<? extends Object> type, String...parameters) {
	...
	public static Filter factory(String... parameters) {
		return new DateDifferentThanFilter(DateParam.class, parameters);
	}
	...
	public static Filter factory(DatabaseAlias... databaseAliases){
		return new DateDifferentThanFilter(DateParam.class, databaseAliases);
	}
