 ...
 * 
 * O retorno é formado por todos os resources cujo valor desse campo é MENOR QUE ou IGUAL ao valor informado.
 *
 */
public class LowerThanOrEqualToFilter extends Filter {
	
	//TODO TODAS ASS FILHAS DE Filter DEVEM ter os construtores dessa maneira:
	protected LowerThanOrEqualToFilter(Class<? extends Object> type, DatabaseAlias...databaseAliases) {
		super(type, databaseAliases);
	}
	protected LowerThanOrEqualToFilter(DatabaseAlias...databaseAliases) {
		super(databaseAliases);
	}
	protected LowerThanOrEqualToFilter(Class<? extends Object> type, String...parameters) {
		super(type, parameters);
	}
	protected LowerThanOrEqualToFilter(String...parameters) {
		super(parameters);
	}
	...
	public static Filter factory(String... parameters) {
		return new LowerThanOrEqualToFilter(parameters);
	}
	...
	public static Filter factory(DatabaseAlias... databaseAliases) {
		return new LowerThanOrEqualToFilter(databaseAliases);	
	}
	...
	public static Filter factory(Class<? extends Object> type,
		...
		if(type.equals(Integer.class) || type.equals(Float.class) || type.equals(Double.class))
			return new LowerThanOrEqualToFilter(type, databaseAliases);
	...
	public static Filter factory(Class<? extends Object> type, String... parameters) throws CoreException {
		if(type.equals(Integer.class) || type.equals(Float.class) || type.equals(Double.class))
			return new LowerThanOrEqualToFilter(type, parameters);
		else throw new CoreException(Errors.FILTER_TIPO_INVALIDO, "O tipo passado para o LowerThanFilter não é compatível. Consulte a documentação para mais informações.");
	}
